...
const Head = () => {
  ...
  return (
    <div className="sticky top-0 bg-white grid grid-flow-col w-full py-3 px-1 md:px-3">
      ...
      <div
        className={`flex col-span-2 mx-4 items-center md:col-span-1 ${
      ...
      >
        <div className="group flex flex-row ">
          <input
            type="text"
            placeholder="Search"
            className="w-96 rounded-l-full pl-4 py-1 shadow-inner border border-gray-300 hover:border-gray-400 focus:outline-none "
            value={searchQuery}
            onChange={(e) => {
          ...
          <button className={`rounded-r-full p-5 py-1 shadow-inner border border-gray-300 hover:border-gray-400 ${!smSearch ? 'max-sm:border-none max-sm:rounded-full' : ''} md:py-2 md:px-5 bg-gray-100 focus:outline-none`}  onClick={()=>{
